...
function Puddle() {
  ...
  const track2 =
    "https://www.dl.dropboxusercontent.com/scl/fo/7ux9oi2h094kwwp8heg54/AFsZaXeSufUYy8El6JPQYWs/PDDL%20T02v1-M02%20Kitty%20Conundrum.wav?rlkey=c6sh6gtchz60ucqyjimbgc4cs&e=1&dl=0";
  const track3 =
    "https://www.dl.dropboxusercontent.com/scl/fo/7ux9oi2h094kwwp8heg54/AIikV1FsR0s-XTO0Q3u4bjU/PDDL%20T03v1-M03%20Mac%20n'%20Puddle.wav?rlkey=c6sh6gtchz60ucqyjimbgc4cs&e=1&dl=0";

  const trackInfo = [
    {
      title: "Meowning Routine",
      track: track1,
      index: "1",
      length: "1:27",
    },
    {
      title: "Kitty Conundrum",
      track: track2,
      index: "2",
      length: "1:10",
    },
        ...
        <Container>
          <Row>
            <Col style={{ alignContent: "left", paddingLeft: "18%" }}>
              ...
              >
                <i>Short Film / Stop Motion Comedy</i>
              </p>
              <Container>
                <Row>
                  <Col xl={4}>
                    ...
                    >
                      ...
                      <a
                        ...
                        href="https://www.youtube.com/watch?v=wHd7N6gj7u4&list=PLWLXJaKFBj4KhRrTbwKKzPgPgoc8f6WjN"
                      >
                        {youTubeMouseOver ? (
                          <svg
                      ...
                      <a
                        ...
                        href="https://soundcloud.com/marcyumusic/sets/puddle-original-soundtrack"
                      >
                        {soundcloudMouseOver ? (
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  <Col style={{ paddingRight: "18%", paddingLeft: "2%" }}>
                    <div style={{ color: "white", fontFamily: "Georgia" }}>
                      ...
                      >
                        ...
                        <li>
                          Banjo:{" "}
                          <span style={{ color: "#B9BAB9" }}>G Rockwell</span>
                        </li>
                        <li>
                          Drums:{" "}
                      ...
                      <p style={{ fontSize: "1.1rem", color: "#B9BAB9" }}>
                        When the AC turns off, your typical, totally (para)normal, pantomorphic, and cat-astrophic hijinks ensue.
<br/><br/>
                        Created by Sam Holovacs
                      </p>
                    </div>
                  </Col>
                </Row>
