...
function ROTS() {
    ...
    const track1 = "https://www.dl.dropboxusercontent.com/scl/fi/uifjm1bauwvldiiuy76el/ROTS-DELTA-M01v2-Delta-Emblock-s-Theme.wav?rlkey=043vo2m4p7m7y3zu2vdnemhdw&e=1&dl=0"
    const trackInfo = [
        {
            title: "Ghosts (Delta's Theme)",
            track: track1,
            index: "1",
            length: "2:32",
        }
